...
_TEXT = {
    "EN": {
        ...
        "enable_rmb_click_hold": "Enable RMB click/hold separation",
        "rmb_hold_duration": "RMB hold duration",
        "speed": "Speed",
        "motion": "Motion",
        ...
        "version": "Version 1.1.0 — Matsm Studio",
        ...
        "save_preferences_hint": "Save current settings or restore every option to its default value",
        "preferences_saved": "Blender preferences saved",
        "preferences_reset": "Add-on settings restored to defaults",
    ...
    "PL": {
        ...
        "enable_rmb_click_hold": "Rozróżniaj kliknięcie i przytrzymanie PPM",
        "rmb_hold_duration": "Czas przytrzymania PPM",
        "speed": "Prędkość",
        "motion": "Ruch",
        ...
        "version": "Wersja 1.1.0 — Matsm Studio",
        ...
        "save_preferences": "Zapisz na dysku",
        "reset_preferences": "Przywróć domyślne",
        "save_preferences_hint": "Zapisz bieżące ustawienia lub przywróć wszystkie opcje domyślne",
        "preferences_saved": "Ustawienia Blendera zostały zapisane",
        "preferences_reset": "Przywrócono domyślne ustawienia dodatku",
        "preferences_save_failed": "Nie udało się zapisać ustawień Blendera: {error}",
